...
```
docker run -p 4242:4242 -p 8042:8042 --rm -v /path/to/Configuration.json:/etc/orthanc/orthanc.json:ro -v /path/to/Storage/:/var/lib/orthanc/db/ orthanc-sphaeroptica
```
